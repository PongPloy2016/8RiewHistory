...
public class watchramActivity3 extends Activity {
        ...
        View.OnClickListener clickListener = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (v.getId() == R.id.btn_play) {
                    String url = "http://content.jwplatform.com/videos/SohT0vBE-eRjqu5Ta.mp4";
                    player.play(url);
                    player.setTitle(url);
                    ...
                    Paper.book().write("MapCheck", "5"); // Primitive
